...
---
#### XLDBTumba01 
[**`Metadata`**](./runs.md#xldbtumba01) | [**`Participants`**](./participants.md#ulisboatumba)| [**`Input`**](https://trec.nist.gov/results/trec13/web/input.XLDBTumba01.gz)| [**`Summary`**](https://trec.nist.gov/results/trec13/web/summary.XLDBTumba01.gz)| [**`Appendix`**](https://trec.nist.gov/pubs/trec13/appendices/web/u.lisboa.tumba.mixed.pdf)
??? example "summary (trec_eval)"
	```
	map				all	0.0025
	bpref			all	0.0048
	recip_rank		all	0.0615
	P_10			all	0.0107
	P_100			all	0.0017
	P_1000			all	0.0002
	map				all	0.0615
