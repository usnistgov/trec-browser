...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 9/7/2005 
- :material-text-search: **Task:** run 
...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 9/6/2005 
- :material-text-search: **Task:** run 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Using CNG method with profile aging; byte n-grams (n=4) 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Later... Perl, ngram-based etc. 
...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 9/11/2005 
- :material-text-search: **Task:** run 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Using CNG method with profile aging; byte n-grams (n=5) 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** limited ngram based naive bayes with white list 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** used spamassassin corpus as training 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** An winnow algorithms,using structure-based hierarchical model. 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** An winnow algorithms,using multi-feature model. 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** An nBayes algorithms,using structure-based hierarchical model.  
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** An nBayes algorithms,using multi-feature model. 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** An hierarchical filter,and use winnow as the classifier.  
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Fusion filter (Naive Bayes, Rule-based, Pattern-based, Blacklist) with large training data 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Fusion filter (Naive Bayes, Rule-based, Pattern-based, Blacklist) with training after each classification 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Fusion filter (Naive Bayes, Rule-based, Pattern-based, Blacklist) with training only after misclassification 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Prototype Fusion filter (Naive Bayes, Rule-based, Pattern-based, Blacklist) with large training data 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** Fusion filter that combines Bayesian filter, rule-based filter, pattern-based filter, and blacklist filter 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** KidultPRIS is a command line program which is exploited by the members in the lab of Pattern Recognition and Intelligent System, Beijing University of Posts and Telecommunications. 
...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 6/30/2005 
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** KidultPRIS is a command line program which is exploited by the members in the lab of Pattern Recognition and Intelligent System, Beijing University of Posts and Telecommunications.  
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** This is just a pilot system. Based on ifile system developed by Jason Rennie, we incorporate other machine learning methods in this system. please see the incoming final filter system and its Readme file. 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** This filter tests the cef tokenizer with full standard header analysis and uniform reference measure, case sensitive tokens.  
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** This filter tests the adp tokenizer with full standard header analysis and uniform reference measure, lowercase tokens.  
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** This filter tests the adp tokenizer with full standard header analysis and dirichlet reference measure, lowercase tokens.  
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** This filter tests the adp tokenizer with only Subject analysis, uniform reference measure, lowercase tokens.  
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** It is based on unigram language models, one for ham messages and another for ham messages. It computes the message  likelihood given these two models and uses the values to classify the message. Uses spamassassin corpus as training data. 
...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 8/23/2005 
- :material-text-search: **Task:** run 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** It is based on unigram language models, one for ham messages and another for ham messages. It computes the message  likelihood given these two models and uses the values to classify the message.  
...
- :material-format-text: **Track:** Spam 
- :material-calendar: **Year:** 2005 
- :material-upload: **Submission:** 9/10/2005 
- :material-text-search: **Task:** run 
...
- :fontawesome-solid-user-gear: **Type:** final 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** SpamBayes 1.1 (see http //spambayes.org for full details, including source), with all possible tokenization options turned on and using train-to-exhaustion (se description for run #3).  See previous run descriptions for more details. 
...
- :fontawesome-solid-user-gear: **Type:** pilot 
- :material-text-search: **Task:** filter 
- :material-text: **Run description:** SpamBayes 1.1.  Uses chi-squared combining (both thresholds set at 0.6 to eliminate unsure range) statistical method.  No prior training. 
