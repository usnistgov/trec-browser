...
- :material-email: **Email:** dutjinsong [at] gmail [dot] com 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 7/1/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :material-email: **Email:** urbain [at] msoe [dot] edu 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 7/8/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :fontawesome-solid-user-group: **Participant:** msoe 
- :material-email: **Email:** jay [dot] urbain [at] gmail [dot] com 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 9/5/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :material-email: **Email:** scetintas [at] gmail [dot] com 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 9/6/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :fontawesome-solid-user-group: **Participant:** Purdue_Si 
- :material-email: **Email:** scetinta [at] cs [dot] purdue [dot] edu 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 9/6/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :material-email: **Email:** hgurulingappa [at] scai [dot] fhg [dot] de 
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 9/6/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart 
- :material-fingerprint: **MD5:** `b5c165707d0d27783ddd2bae57de327f` 
- :material-text: **Run description:** Doc vs Doc; concept based (priority to related hyponyms and hypernyms); Result unfiltered 
...
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `9f39f9dd0ffb767e138cded643d5b96a` 
- :material-text: **Run description:** Manually formulated queries for searching the document index 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `7ed4eba648494475dbed0464c0fa58ce` 
- :material-text: **Run description:** A combination of noun phrase chunking, stop word removal and data cleansing for querying against document index.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `178e14b89570af8f3c94a49d1781bdc2` 
- :material-text: **Run description:** Use of a preprocessed dictionary and in-house Named Entity Recognition system for document retrieval 
...
- :material-format-text: **Track:** Chemical 
- :material-calendar: **Year:** 2009 
- :material-upload: **Submission:** 9/4/2009 
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart 
- :material-fingerprint: **MD5:** `93a8e5d3da6513d6d13755c9357f359e` 
- :material-text: **Run description:** We produced 2 separate indexes using Lucene: one using the claims and title information only; the other using other information in the patent including the description, abstract, and classification.  We used a specific technique to "un-nest" the claims so they would each be independent documents for evaluation. After limiting the available matching patents using the priority date as a threshold, we merged these two indexes using a weighted ratio and obtained a ranked list of resultant patent documents.  These patents were then unduplicated, taking the lowest ranked value of a candidate patent. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart_sm 
- :material-fingerprint: **MD5:** `4371efb08001cc4c82dd4d1f40a8c1ab` 
- :material-text: **Run description:** This run is highly experimental, and used the primary classification and title information to determine an appropriate set of patents to match with, with a heavy weighting on the primary classification.  This run allowed the primary patent classification for the target patent to match against the primary classifications for the most appropriate candidate patents.  Because priority dates were not used, only an approximation of the earlier patent numbers could be made.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart_sm 
- :material-fingerprint: **MD5:** `2718980578125492ce8df52353a396b8` 
- :material-text: **Run description:** This run is similar to the UIowaS09PA2 run and used the primary classification and title information to determine an appropriate set of patents to match with, with a heavy weighting on the primary classification.  This run allowed the primary patent classification for the target patent to match against the primary classifications for the most appropriate candidate patents.  This run uses a better approximation of priority dates than UIowaS09PA2, at the expense of returning fewer patents per query.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `fe8ad672ab3f68e5b851840b027393e6` 
- :material-text: **Run description:** We have used Okapi(model: BM25) for retrieval.  For documents: Only title and abstract are utilized.  For topics: We used query, narrative and some expanded keywords. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `e220af53f5bf6734e6bad4fee2e21f09` 
- :material-text: **Run description:** First, we use the Lucene IR system to build the index for each field. Second, BM25 with default parameter settings is used for weighting.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `aede8abdd2f779cba50c019af6a135e7` 
- :material-text: **Run description:** First, we use the Lucene IR system to build the index for each field. Second, BM25 with default parameter settings is used for weighting. Only the "query" field is used.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `c36e51521dcfada87272b664b949a188` 
- :material-text: **Run description:** Okapi, we only built index based on the title and abstract of the documents.  
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `e5c2761245cb01519b79dfe36e7f98f7` 
- :material-text: **Run description:** Okapi, we only built index based on the title and abstract of the documents. We only used "query" field of topics to retrive. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `f69845471644e086d04ff8b64810f8da` 
- :material-text: **Run description:** We have used Lucene(model: BM25) for retrieval.  For documents: Whole document. For topics: We used query, narrative and some expanded keywords. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** techsurv 
- :material-fingerprint: **MD5:** `866944d8b7ab32fc10e0f05e01334c40` 
- :material-text: **Run description:** We have used Lucene(model: Language Model) for retrieval.  For documents: Whole document. For topics: We used query, narrative and some expanded keywords. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart 
- :material-fingerprint: **MD5:** `09b3570d56638e352ddac6bf46c8abeb` 
- :material-text: **Run description:** We extracted 30 keywords from title and claim for each topic, and used BM25 as weighting function. 
...
- :fontawesome-solid-user-gear: **Type:** automatic 
- :material-text-search: **Task:** priorart 
- :material-fingerprint: **MD5:** `776b778b3f890d157b22eac158555da7` 
- :material-text: **Run description:** We extracted 100 keywords from title and claim for each topic, and used BM25 as weighting function. 
