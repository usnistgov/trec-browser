...
---
#### GE4 
[**`Metadata`**](./runs.md#ge4), [**`Participants`**](./participants.md#rmit), [**`Proceedings`**](./proceedings.md#using-meda-data-to-search-for-clinical-records-rmit-at-trec-2012-medical-track), [**`Input`**](https://trec.nist.gov/results/trec21/medical/input.GE4.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec21/medical/summary.trec_eval.GE4), [**`Summary (sample-eval)`**](https://trec.nist.gov/results/trec21/medical/summary.sample-eval.GE4), [**`Appendix`**](https://trec.nist.gov/pubs/trec21/appendices/medical/GE4.pdf)
??? example "summary (sample-eval)"
	```
	infAP 			 all 0.1429 
	infNDCG 		 all 0.3312 
