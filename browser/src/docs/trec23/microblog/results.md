...
---
#### UDInfoMMRA 
[**`Metadata`**](./runs.md#udinfommra), [**`Participants`**](./participants.md#udel_fang), [**`Proceedings`**](./proceedings.md#concept-based-tie-breaking-and-maximal-marginal-relevance-retrieval-in-microblog-retrieval), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/UDInfoMMRA.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-ttg-UDInfoMMRA.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/UDInfoMMRA.pdf)
??? example "summary (ttg)"
	```
	unweighted_recall		0.0652
	weighted_recall		0.1806
	precision		0.5314

	```
---
#### UDInfoMMR5 
[**`Metadata`**](./runs.md#udinfommr5), [**`Participants`**](./participants.md#udel_fang), [**`Proceedings`**](./proceedings.md#concept-based-tie-breaking-and-maximal-marginal-relevance-retrieval-in-microblog-retrieval), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/UDInfoMMR5.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-ttg-UDInfoMMR5.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/UDInfoMMR5.pdf)
??? example "summary (ttg)"
	```
	unweighted_recall		0.0743
	weighted_recall		0.2035
	precision		0.5055

	```
---
#### UDInfoMMRWCA 
[**`Metadata`**](./runs.md#udinfommrwca), [**`Participants`**](./participants.md#udel_fang), [**`Proceedings`**](./proceedings.md#concept-based-tie-breaking-and-maximal-marginal-relevance-retrieval-in-microblog-retrieval), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/UDInfoMMRWCA.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-ttg-UDInfoMMRWCA.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/UDInfoMMRWCA.pdf)
??? example "summary (ttg)"
	```
	unweighted_recall		0.0852
	weighted_recall		0.2010
	precision		0.5919

	```
---
#### UDInfoMMRWC5 
[**`Metadata`**](./runs.md#udinfommrwc5), [**`Participants`**](./participants.md#udel_fang), [**`Proceedings`**](./proceedings.md#concept-based-tie-breaking-and-maximal-marginal-relevance-retrieval-in-microblog-retrieval), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/UDInfoMMRWC5.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-ttg-UDInfoMMRWC5.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/UDInfoMMRWC5.pdf)
??? example "summary (ttg)"
	```
	unweighted_recall		0.0900
	weighted_recall		0.2191
	precision		0.5709

	```
---
#### PolyURun3 
[**`Metadata`**](./runs.md#polyurun3), [**`Participants`**](./participants.md#polyucomp), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/PolyURun3.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-adhoc-PolyURun3.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/PolyURun3.pdf)
??? example "summary (adhoc)"
	```
	map 			 all 0.5109 
	bpref 			 all 0.5196 
...
---
#### HPRF1020 
[**`Metadata`**](./runs.md#hprf1020), [**`Participants`**](./participants.md#qcri), [**`Proceedings`**](./proceedings.md#qcri-at-trec-2014-applying-the-kiss-principle-for-the-ttg-task-in-the-microblog-track), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/HPRF1020.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-adhoc-HPRF1020.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/HPRF1020.pdf)
??? example "summary (adhoc)"
	```
	map 			 all 0.5075 
	bpref 			 all 0.5061 
	recip_rank 		 all 0.8273 
	P_10 			 all 0.7727 
	P_100 			 all 0.4996 
	P_1000 			 all 0.1586 
...
---
#### PRF1030RR 
[**`Metadata`**](./runs.md#prf1030rr), [**`Participants`**](./participants.md#qcri), [**`Proceedings`**](./proceedings.md#qcri-at-trec-2014-applying-the-kiss-principle-for-the-ttg-task-in-the-microblog-track), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/PRF1030RR.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-adhoc-PRF1030RR.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/PRF1030RR.pdf)
??? example "summary (adhoc)"
	```
	map 			 all 0.4998 
	bpref 			 all 0.4968 
...
---
#### PRF1030 
[**`Metadata`**](./runs.md#prf1030), [**`Participants`**](./participants.md#qcri), [**`Proceedings`**](./proceedings.md#qcri-at-trec-2014-applying-the-kiss-principle-for-the-ttg-task-in-the-microblog-track), [**`Input`**](https://trec.nist.gov/results/trec23/microblog/PRF1030.gz), [**`Summary`**](https://trec.nist.gov/results/trec23/microblog/summary-adhoc-PRF1030.txt), [**`Appendix`**](https://trec.nist.gov/pubs/trec23/appendices/microblog/PRF1030.pdf)
??? example "summary (adhoc)"
	```
	map 			 all 0.4941 
	bpref 			 all 0.4929 
	recip_rank 		 all 0.8530 
	P_10 			 all 0.7655 
	P_100 			 all 0.4909 
	P_1000 			 all 0.1565 
