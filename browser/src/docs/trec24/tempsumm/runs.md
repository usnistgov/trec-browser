...
- :material-text: **Run description:** In this runI adopt the improved Non-negative matrix factorization algorithm with two regularizations  as the cluster method .One regularization considers both structure of manifold and structure of semantics the other regularization is L2-norm to control the complexity of model .Compared with APCLUSTER Affinity Propagation Clustering algorithm,in some topics ,our method is better or comparable in residual error. 
