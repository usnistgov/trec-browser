...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4651 
	bpref 			 all 0.5676 
	recip_rank 		 all 0.7736 
	P_10 			 all 0.6907 
	P_100 			 all 0.3593 
	P_1000 			 all 0.0744 
	recall_10 		 all 0.1438 
	recall_100 		 all 0.4995 
	recall_1000 	 all 0.8129 
	ndcg 			 all 0.6648 
	ndcg_cut_10 	 all 0.5511 
	ndcg_cut_100 	 all 0.5496 
	ndcg_cut_1000 	 all 0.6648 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.3609 
	P_1000 			 all 0.0705 
	recall_10 		 all 0.1387 
	recall_100 		 all 0.4974 
	recall_1000 	 all 0.7845 
	ndcg 			 all 0.6438 
	ndcg_cut_10 	 all 0.5372 
	ndcg_cut_100 	 all 0.5448 
	ndcg_cut_1000 	 all 0.6438 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.3766 
	bpref 			 all 0.4960 
	recip_rank 		 all 0.8457 
	P_10 			 all 0.6047 
	P_100 			 all 0.3219 
	P_1000 			 all 0.0653 
	recall_10 		 all 0.1263 
	recall_100 		 all 0.4603 
	recall_1000 	 all 0.7384 
	ndcg 			 all 0.6001 
	ndcg_cut_10 	 all 0.4973 
	ndcg_cut_100 	 all 0.4981 
	ndcg_cut_1000 	 all 0.6001 
...
---
#### bm25tuned_ax_p 
[**`Metadata`**](./runs.md#bm25tuned_ax_p), [**`Participants`**](./participants.md#baseline), [**`Input`**](https://trec.nist.gov/results/trec28/deep/input.bm25tuned_ax_p.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec28/deep/summary.treceval.bm25tuned_ax_p), [**`Summary (passages-eval)`**](https://trec.nist.gov/results/trec28/deep/summary.passages-eval.bm25tuned_ax_p), [**`Appendix`**](https://trec.nist.gov/pubs/trec28/appendices/deep/bm25tuned_ax_p.pdf)
??? example "summary (passages-eval)"
	```
	map 			 all 0.3632 
	bpref 			 all 0.3945 
	recip_rank 		 all 0.6481 
	P_10 			 all 0.4465 
	P_100 			 all 0.2233 
	P_1000 			 all 0.0458 
	recall_10 		 all 0.2085 
	recall_100 		 all 0.5404 
	recall_1000 	 all 0.8138 
	ndcg 			 all 0.6663 
	ndcg_cut_10 	 all 0.5461 
	ndcg_cut_100 	 all 0.5564 
	ndcg_cut_1000 	 all 0.6663 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4722 
	bpref 			 all 0.5706 
	recip_rank 		 all 0.8218 
	P_10 			 all 0.6907 
	P_100 			 all 0.3640 
	P_1000 			 all 0.0741 
	recall_10 		 all 0.1495 
	recall_100 		 all 0.5065 
	recall_1000 	 all 0.8094 
	ndcg 			 all 0.6663 
	ndcg_cut_10 	 all 0.5461 
	ndcg_cut_100 	 all 0.5564 
	ndcg_cut_1000 	 all 0.6663 
...
??? example "summary (passages-eval)"
	...
	P_100 			 all 0.2135 
	P_1000 			 all 0.0444 
	recall_10 		 all 0.1951 
	recall_100 		 all 0.5143 
	recall_1000 	 all 0.7792 
	ndcg 			 all 0.6370 
	ndcg_cut_10 	 all 0.5231 
	ndcg_cut_100 	 all 0.5263 
	ndcg_cut_1000 	 all 0.6370 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4249 
	bpref 			 all 0.5296 
	recip_rank 		 all 0.8229 
	P_10 			 all 0.6395 
	P_100 			 all 0.3442 
	P_1000 			 all 0.0709 
	recall_10 		 all 0.1324 
	recall_100 		 all 0.4747 
	recall_1000 	 all 0.7762 
	ndcg 			 all 0.6370 
	ndcg_cut_10 	 all 0.5231 
	ndcg_cut_100 	 all 0.5263 
	ndcg_cut_1000 	 all 0.6370 
...
---
#### bm25tuned_prf_p 
[**`Metadata`**](./runs.md#bm25tuned_prf_p), [**`Participants`**](./participants.md#baseline), [**`Input`**](https://trec.nist.gov/results/trec28/deep/input.bm25tuned_prf_p.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec28/deep/summary.treceval.bm25tuned_prf_p), [**`Summary (passages-eval)`**](https://trec.nist.gov/results/trec28/deep/summary.passages-eval.bm25tuned_prf_p), [**`Appendix`**](https://trec.nist.gov/pubs/trec28/appendices/deep/bm25tuned_prf_p.pdf)
??? example "summary (passages-eval)"
	```
	map 			 all 0.3684 
	bpref 			 all 0.3960 
	recip_rank 		 all 0.6996 
	P_10 			 all 0.4721 
	P_100 			 all 0.2272 
	P_1000 			 all 0.0440 
	recall_10 		 all 0.2142 
	recall_100 		 all 0.5420 
	recall_1000 	 all 0.7988 
	ndcg 			 all 0.6529 
	ndcg_cut_10 	 all 0.5536 
	ndcg_cut_100 	 all 0.5514 
	ndcg_cut_1000 	 all 0.6529 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4522 
	bpref 			 all 0.5527 
	recip_rank 		 all 0.8178 
	P_10 			 all 0.6698 
	P_100 			 all 0.3630 
	P_1000 			 all 0.0711 
	recall_10 		 all 0.1372 
	recall_100 		 all 0.4969 
	recall_1000 	 all 0.7894 
	ndcg 			 all 0.6529 
	ndcg_cut_10 	 all 0.5536 
	ndcg_cut_100 	 all 0.5514 
	ndcg_cut_1000 	 all 0.6529 
...
??? example "summary (passages-eval)"
	...
	P_1000 			 all 0.0375 
	recall_10 		 all 0.2706 
	recall_100 		 all 0.5821 
	recall_1000 	 all 0.6943 
	ndcg 			 all 0.6627 
	ndcg_cut_10 	 all 0.7314 
	ndcg_cut_100 	 all 0.6346 
	ndcg_cut_1000 	 all 0.6627 
...
??? example "summary (passages-eval)"
	...
	P_100 			 all 0.2735 
	P_1000 			 all 0.0420 
	recall_10 		 all 0.2596 
	recall_100 		 all 0.5956 
	recall_1000 	 all 0.7481 
	ndcg 			 all 0.6981 
	ndcg_cut_10 	 all 0.7336 
	ndcg_cut_100 	 all 0.6547 
	ndcg_cut_1000 	 all 0.6981 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4994 
	bpref 			 all 0.6104 
	recip_rank 		 all 0.9568 
	P_10 			 all 0.8488 
	P_100 			 all 0.3965 
	P_1000 			 all 0.0664 
	recall_10 		 all 0.1789 
	recall_100 		 all 0.5356 
	recall_1000 	 all 0.7352 
	ndcg 			 all 0.6981 
	ndcg_cut_10 	 all 0.7336 
	ndcg_cut_100 	 all 0.6547 
	ndcg_cut_1000 	 all 0.6981 
...
??? example "summary (passages-eval)"
	...
	recall_100 		 all 0.6239 
	recall_1000 	 all 0.8060 
	ndcg 			 all 0.7337 
	ndcg_cut_10 	 all 0.7422 
	ndcg_cut_100 	 all 0.6745 
	ndcg_cut_1000 	 all 0.7337 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.5524 
	recall_1000 	 all 0.7803 
	ndcg 			 all 0.7337 
	ndcg_cut_10 	 all 0.7422 
	ndcg_cut_100 	 all 0.6745 
	ndcg_cut_1000 	 all 0.7337 
...
??? example "summary (passages-eval)"
	...
	P_100 			 all 0.2705 
	P_1000 			 all 0.0405 
	recall_10 		 all 0.2598 
	recall_100 		 all 0.6008 
	recall_1000 	 all 0.7450 
	ndcg 			 all 0.6975 
	ndcg_cut_10 	 all 0.7380 
	ndcg_cut_100 	 all 0.6585 
	ndcg_cut_1000 	 all 0.6975 
...
---
#### ICT-BERT2 
[**`Metadata`**](./runs.md#ict-bert2), [**`Participants`**](./participants.md#ictnet), [**`Proceedings`**](./proceedings.md#ictnet-at-trec-2019-deep-learning-track), [**`Input`**](https://trec.nist.gov/results/trec28/deep/input.ICT-BERT2.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec28/deep/summary.treceval.ICT-BERT2), [**`Summary (passages-eval)`**](https://trec.nist.gov/results/trec28/deep/summary.passages-eval.ICT-BERT2), [**`Appendix`**](https://trec.nist.gov/pubs/trec28/appendices/deep/ICT-BERT2.pdf)
??? example "summary (passages-eval)"
	```
	map 			 all 0.2421 
	bpref 			 all 0.2533 
	recip_rank 		 all 0.8743 
	P_10 			 all 0.5581 
	P_100 			 all 0.0765 
	P_1000 			 all 0.0077 
	recall_10 		 all 0.2415 
	recall_100 		 all 0.3017 
	recall_1000 	 all 0.3017 
	ndcg 			 all 0.3452 
	ndcg_cut_10 	 all 0.6650 
	ndcg_cut_100 	 all 0.3643 
	ndcg_cut_1000 	 all 0.3452 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.1941 
	bpref 			 all 0.2074 
	recip_rank 		 all 0.9529 
	P_10 			 all 0.7372 
	P_100 			 all 0.1153 
	P_1000 			 all 0.0115 
	recall_10 		 all 0.1539 
	recall_100 		 all 0.2162 
	recall_1000 	 all 0.2162 
	ndcg 			 all 0.3452 
	ndcg_cut_10 	 all 0.6650 
...
---
#### srchvrs_ps_run1 
[**`Metadata`**](./runs.md#srchvrs_ps_run1), [**`Participants`**](./participants.md#srchvrs), [**`Input`**](https://trec.nist.gov/results/trec28/deep/input.srchvrs_ps_run1.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec28/deep/summary.treceval.srchvrs_ps_run1), [**`Summary (passages-eval)`**](https://trec.nist.gov/results/trec28/deep/summary.passages-eval.srchvrs_ps_run1), [**`Appendix`**](https://trec.nist.gov/pubs/trec28/appendices/deep/srchvrs_ps_run1.pdf)
??? example "summary (passages-eval)"
	```
	map 			 all 0.2972 
	bpref 			 all 0.3385 
	recip_rank 		 all 0.5597 
	P_10 			 all 0.4186 
	P_100 			 all 0.2144 
	P_1000 			 all 0.0404 
	recall_10 		 all 0.1858 
	recall_100 		 all 0.5264 
	recall_1000 	 all 0.7405 
	ndcg 			 all 0.5960 
	ndcg_cut_10 	 all 0.4990 
	ndcg_cut_100 	 all 0.5099 
...
---
#### srchvrs_ps_run2 
[**`Metadata`**](./runs.md#srchvrs_ps_run2), [**`Participants`**](./participants.md#srchvrs), [**`Input`**](https://trec.nist.gov/results/trec28/deep/input.srchvrs_ps_run2.gz), [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec28/deep/summary.treceval.srchvrs_ps_run2), [**`Summary (passages-eval)`**](https://trec.nist.gov/results/trec28/deep/summary.passages-eval.srchvrs_ps_run2), [**`Appendix`**](https://trec.nist.gov/pubs/trec28/appendices/deep/srchvrs_ps_run2.pdf)
??? example "summary (passages-eval)"
	```
	map 			 all 0.4090 
	bpref 			 all 0.4325 
	recip_rank 		 all 0.8302 
	P_10 			 all 0.5674 
	P_100 			 all 0.2481 
	P_1000 			 all 0.0360 
	recall_10 		 all 0.2617 
	recall_100 		 all 0.5682 
	recall_1000 	 all 0.6837 
	ndcg 			 all 0.6317 
	ndcg_cut_10 	 all 0.6645 
	ndcg_cut_100 	 all 0.6030 
	ndcg_cut_1000 	 all 0.6317 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4545 
	bpref 			 all 0.5374 
	recip_rank 		 all 0.9581 
	P_10 			 all 0.7930 
	P_100 			 all 0.3644 
	P_1000 			 all 0.0572 
	recall_10 		 all 0.1708 
	recall_100 		 all 0.5034 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.4133 
	bpref 			 all 0.5227 
	recip_rank 		 all 0.8429 
	P_10 			 all 0.7023 
	P_100 			 all 0.3423 
	P_1000 			 all 0.0643 
	recall_10 		 all 0.1522 
	recall_100 		 all 0.4797 
	recall_1000 	 all 0.7114 
	ndcg 			 all 0.6119 
	ndcg_cut_10 	 all 0.5558 
	ndcg_cut_100 	 all 0.5299 
