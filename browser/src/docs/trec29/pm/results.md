...
---
#### pozbaseline 
[**`Metadata`**](./runs.md#pozbaseline) | [**`Participants`**](./participants.md#poznan) | [**`Proceedings`**](./proceedings.md#poznan-contribution-to-trec-pm-2020)| [**`Input`**](https://trec.nist.gov/results/trec29/pm/input.pozbaseline.gz)| [**`Summary (trec_eval)`**](https://trec.nist.gov/results/trec29/pm/summary.treceval.pozbaseline) | [**`Summary (sample-eval)`**](https://trec.nist.gov/results/trec29/pm/summary.sample-eval.pozbaseline) | [**`Summary (evidence-eval)`**](https://trec.nist.gov/results/trec29/pm/summary.evidence-eval.pozbaseline)| [**`Appendix`**](https://trec.nist.gov/pubs/trec29/appendices/pm/pozbaseline.pdf)
??? example "summary (evidence-eval)"
	```
