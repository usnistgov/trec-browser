...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0781 
	bpref 			 all 0.0989 
	recip_rank 		 all 0.7133 
	P_10 			 all 0.3658 
	P_100 			 all 0.0611 
	P_1000 			 all 0.0061 
	recall_10 		 all 0.0798 
	recall_100 		 all 0.1185 
	recall_1000 	 all 0.1185 
	ndcg 			 all 0.1772 
	ndcg_cut_10 	 all 0.3747 
	ndcg_cut_100 	 all 0.1887 
	ndcg_cut_1000 	 all 0.1779 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2137 
	ndcg_cut_1000 	 all 0.1638 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0611 
	P_1000 			 all 0.0061 
	recall_10 		 all 0.0822 
	recall_100 		 all 0.1185 
	recall_1000 	 all 0.1185 
	ndcg 			 all 0.1707 
	ndcg_cut_10 	 all 0.3635 
	ndcg_cut_100 	 all 0.1823 
	ndcg_cut_1000 	 all 0.1715 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0784 
	P_1000 			 all 0.0078 
	recall_10 		 all 0.0904 
	recall_100 		 all 0.1382 
	recall_1000 	 all 0.1382 
	ndcg 			 all 0.1964 
	ndcg_cut_10 	 all 0.3913 
	ndcg_cut_100 	 all 0.2099 
	ndcg_cut_1000 	 all 0.1971 
...
??? example "summary (trec_eval)"
	...
	P_1000 			 all 0.0240 
	recall_10 		 all 0.0822 
	recall_100 		 all 0.2010 
	recall_1000 	 all 0.2010 
	ndcg 			 all 0.2839 
	ndcg_cut_10 	 all 0.5843 
	ndcg_cut_100 	 all 0.3394 
	ndcg_cut_1000 	 all 0.2867 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2404 
	P_1000 			 all 0.0240 
	recall_10 		 all 0.0801 
	recall_100 		 all 0.2010 
	recall_1000 	 all 0.2010 
	ndcg 			 all 0.2862 
	ndcg_cut_10 	 all 0.5918 
	ndcg_cut_100 	 all 0.3426 
	ndcg_cut_1000 	 all 0.2891 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.1609 
	bpref 			 all 0.1842 
	recip_rank 		 all 0.9518 
	P_10 			 all 0.7487 
	P_100 			 all 0.2404 
	P_1000 			 all 0.0240 
	recall_10 		 all 0.0799 
	recall_100 		 all 0.2010 
	recall_1000 	 all 0.2010 
	ndcg 			 all 0.2853 
	ndcg_cut_10 	 all 0.5882 
	ndcg_cut_100 	 all 0.3417 
	ndcg_cut_1000 	 all 0.2882 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2816 
	ndcg_cut_1000 	 all 0.2131 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.1382 
	ndcg 			 all 0.2035 
	ndcg_cut_10 	 all 0.4144 
	ndcg_cut_100 	 all 0.2177 
	ndcg_cut_1000 	 all 0.2043 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2819 
	ndcg_cut_1000 	 all 0.2135 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.1382 
	ndcg 			 all 0.2038 
	ndcg_cut_10 	 all 0.4165 
	ndcg_cut_100 	 all 0.2181 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0410 
	bpref 			 all 0.0761 
	recip_rank 		 all 0.3065 
	P_10 			 all 0.1789 
	P_100 			 all 0.0782 
	P_1000 			 all 0.0078 
	recall_10 		 all 0.0356 
	recall_100 		 all 0.1460 
	recall_1000 	 all 0.1460 
	ndcg 			 all 0.1303 
	ndcg_cut_10 	 all 0.1589 
	ndcg_cut_100 	 all 0.1416 
	ndcg_cut_1000 	 all 0.1311 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0847 
	P_1000 			 all 0.0085 
	recall_10 		 all 0.0310 
	recall_100 		 all 0.1485 
	recall_1000 	 all 0.1485 
	ndcg 			 all 0.1343 
	ndcg_cut_10 	 all 0.1659 
	ndcg_cut_100 	 all 0.1460 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2012 
	P_1000 			 all 0.0201 
	recall_10 		 all 0.1227 
	recall_100 		 all 0.3735 
	recall_1000 	 all 0.3735 
	ndcg 			 all 0.3690 
	ndcg_cut_10 	 all 0.4688 
	ndcg_cut_100 	 all 0.3859 
	ndcg_cut_1000 	 all 0.3698 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4703 
	ndcg_cut_1000 	 all 0.3714 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.4137 
	ndcg 			 all 0.4227 
	ndcg_cut_10 	 all 0.5726 
	ndcg_cut_100 	 all 0.4414 
	ndcg_cut_1000 	 all 0.4235 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.1896 
	bpref 			 all 0.2459 
	recip_rank 		 all 0.7782 
	P_10 			 all 0.5684 
	P_100 			 all 0.1859 
	P_1000 			 all 0.0186 
	recall_10 		 all 0.1332 
	recall_100 		 all 0.3349 
	recall_1000 	 all 0.3349 
	ndcg 			 all 0.3638 
	ndcg_cut_10 	 all 0.5391 
	ndcg_cut_100 	 all 0.3812 
	ndcg_cut_1000 	 all 0.3645 
...
??? example "summary (trec_eval)"
	...
	ndcg_cut_100 	 all 0.2842 
	ndcg_cut_1000 	 all 0.2730 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4503 
	ndcg_cut_1000 	 all 0.3527 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2120 
	P_1000 			 all 0.0212 
	recall_10 		 all 0.1370 
	recall_100 		 all 0.3802 
	recall_1000 	 all 0.3802 
	ndcg 			 all 0.4009 
	ndcg_cut_10 	 all 0.5721 
	ndcg_cut_100 	 all 0.4194 
	ndcg_cut_1000 	 all 0.4017 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.4133 
	recall_1000 	 all 0.4133 
	ndcg 			 all 0.4227 
	ndcg_cut_10 	 all 0.5723 
	ndcg_cut_100 	 all 0.4414 
	ndcg_cut_1000 	 all 0.4235 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2228 
	P_1000 			 all 0.0223 
	recall_10 		 all 0.1403 
	recall_100 		 all 0.4149 
	recall_1000 	 all 0.4149 
	ndcg 			 all 0.4234 
	ndcg_cut_10 	 all 0.5716 
	ndcg_cut_100 	 all 0.4421 
	ndcg_cut_1000 	 all 0.4242 
...
??? example "summary (ndcg)"
	```
	ndcg_cut_10 	 all 0.6508 
	ndcg_cut_100 	 all 0.4709 
	ndcg_cut_1000 	 all 0.3719 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3902 
	ndcg_cut_1000 	 all 0.3085 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.3410 
	ndcg 			 all 0.3327 
	ndcg_cut_10 	 all 0.4200 
	ndcg_cut_100 	 all 0.3481 
	ndcg_cut_1000 	 all 0.3333 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.3665 
	ndcg 			 all 0.3606 
	ndcg_cut_10 	 all 0.4710 
	ndcg_cut_100 	 all 0.3768 
	ndcg_cut_1000 	 all 0.3614 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3269 
	ndcg_cut_1000 	 all 0.2644 
...
??? example "summary (trec_eval)"
	...
	P_1000 			 all 0.0124 
	recall_10 		 all 0.1086 
	recall_100 		 all 0.2480 
	recall_1000 	 all 0.2480 
	ndcg 			 all 0.2704 
	ndcg_cut_10 	 all 0.4071 
	ndcg_cut_100 	 all 0.2826 
	ndcg_cut_1000 	 all 0.2711 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4510 
	ndcg_cut_1000 	 all 0.3573 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1972 
	P_1000 			 all 0.0197 
	recall_10 		 all 0.1383 
	recall_100 		 all 0.3739 
	recall_1000 	 all 0.3739 
	ndcg 			 all 0.3881 
	ndcg_cut_10 	 all 0.5281 
	ndcg_cut_100 	 all 0.4048 
	ndcg_cut_1000 	 all 0.3887 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2445 
	P_1000 			 all 0.0244 
	recall_10 		 all 0.0516 
	recall_100 		 all 0.2213 
	recall_1000 	 all 0.2213 
	ndcg 			 all 0.2497 
	ndcg_cut_10 	 all 0.3625 
	ndcg_cut_100 	 all 0.2971 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.1099 
	bpref 			 all 0.1759 
	recip_rank 		 all 0.7093 
	P_10 			 all 0.4776 
	P_100 			 all 0.2350 
	P_1000 			 all 0.0235 
	recall_10 		 all 0.0470 
	recall_100 		 all 0.2162 
	recall_1000 	 all 0.2162 
	ndcg 			 all 0.2433 
	ndcg_cut_10 	 all 0.3603 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4464 
	ndcg_cut_1000 	 all 0.3510 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1953 
	P_1000 			 all 0.0195 
	recall_10 		 all 0.1207 
	recall_100 		 all 0.3681 
	recall_1000 	 all 0.3681 
	ndcg 			 all 0.3703 
	ndcg_cut_10 	 all 0.4856 
	ndcg_cut_100 	 all 0.3870 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3968 
	recall_1000 	 all 0.3968 
	ndcg 			 all 0.4551 
	ndcg_cut_10 	 all 0.6566 
	ndcg_cut_100 	 all 0.5322 
	ndcg_cut_1000 	 all 0.4585 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2029 
	P_1000 			 all 0.0203 
	recall_10 		 all 0.1179 
	recall_100 		 all 0.3762 
	recall_1000 	 all 0.3762 
	ndcg 			 all 0.3757 
	ndcg_cut_10 	 all 0.4921 
	ndcg_cut_100 	 all 0.3928 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2694 
	ndcg_cut_1000 	 all 0.2032 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.1382 
	ndcg 			 all 0.1910 
	ndcg_cut_10 	 all 0.3735 
	ndcg_cut_100 	 all 0.2046 
	ndcg_cut_1000 	 all 0.1918 
...
??? example "summary (trec_eval)"
	...
	ndcg 			 all 0.1955 
	ndcg_cut_10 	 all 0.3811 
	ndcg_cut_100 	 all 0.2092 
	ndcg_cut_1000 	 all 0.1963 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4558 
	ndcg_cut_1000 	 all 0.3584 
...
??? example "summary (trec_eval)"
	...
	ndcg 			 all 0.3763 
	ndcg_cut_10 	 all 0.4859 
	ndcg_cut_100 	 all 0.3942 
	ndcg_cut_1000 	 all 0.3771 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2835 
	bpref 			 all 0.3375 
	recip_rank 		 all 0.9162 
	P_10 			 all 0.8197 
	P_100 			 all 0.4126 
	P_1000 			 all 0.0413 
	recall_10 		 all 0.1022 
	recall_100 		 all 0.3985 
	recall_1000 	 all 0.3985 
	ndcg 			 all 0.4516 
	ndcg_cut_10 	 all 0.6471 
	ndcg_cut_100 	 all 0.5286 
	ndcg_cut_1000 	 all 0.4550 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2692 
	bpref 			 all 0.3196 
	recip_rank 		 all 0.9173 
	P_10 			 all 0.7803 
	P_100 			 all 0.4012 
	P_1000 			 all 0.0401 
	recall_10 		 all 0.0980 
	recall_100 		 all 0.3887 
	recall_1000 	 all 0.3887 
	ndcg 			 all 0.4410 
	ndcg_cut_10 	 all 0.6269 
	ndcg_cut_100 	 all 0.5170 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3742 
	recall_1000 	 all 0.3742 
	ndcg 			 all 0.3708 
	ndcg_cut_10 	 all 0.4704 
	ndcg_cut_100 	 all 0.3876 
	ndcg_cut_1000 	 all 0.3715 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4538 
	ndcg_cut_1000 	 all 0.3564 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2025 
	P_1000 			 all 0.0202 
	recall_10 		 all 0.1212 
	recall_100 		 all 0.3793 
	recall_1000 	 all 0.3793 
	ndcg 			 all 0.3766 
	ndcg_cut_10 	 all 0.4844 
	ndcg_cut_100 	 all 0.3936 
	ndcg_cut_1000 	 all 0.3773 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3842 
	recall_1000 	 all 0.3842 
	ndcg 			 all 0.3841 
	ndcg_cut_10 	 all 0.5030 
	ndcg_cut_100 	 all 0.4021 
	ndcg_cut_1000 	 all 0.3849 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2933 
	bpref 			 all 0.3469 
	recip_rank 		 all 0.9323 
	P_10 			 all 0.8224 
	P_100 			 all 0.4204 
	P_1000 			 all 0.0420 
	recall_10 		 all 0.1039 
	recall_100 		 all 0.4048 
	recall_1000 	 all 0.4048 
	ndcg 			 all 0.4602 
	ndcg_cut_10 	 all 0.6584 
	ndcg_cut_100 	 all 0.5380 
	ndcg_cut_1000 	 all 0.4636 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2740 
	bpref 			 all 0.3242 
	recip_rank 		 all 0.9205 
	P_10 			 all 0.7947 
	P_100 			 all 0.4089 
	P_1000 			 all 0.0409 
	recall_10 		 all 0.1005 
	recall_100 		 all 0.3936 
	recall_1000 	 all 0.3936 
	ndcg 			 all 0.4455 
	ndcg_cut_10 	 all 0.6402 
	ndcg_cut_100 	 all 0.5225 
	ndcg_cut_1000 	 all 0.4488 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2345 
	bpref 			 all 0.2840 
	recip_rank 		 all 0.9039 
	P_10 			 all 0.7395 
	P_100 			 all 0.3701 
	P_1000 			 all 0.0370 
	recall_10 		 all 0.0865 
	recall_100 		 all 0.3471 
	recall_1000 	 all 0.3471 
	ndcg 			 all 0.4055 
	ndcg_cut_10 	 all 0.6094 
	ndcg_cut_100 	 all 0.4766 
	ndcg_cut_1000 	 all 0.4086 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3671 
	recall_1000 	 all 0.3671 
	ndcg 			 all 0.4173 
	ndcg_cut_10 	 all 0.6031 
	ndcg_cut_100 	 all 0.4904 
	ndcg_cut_1000 	 all 0.4204 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4144 
	ndcg_cut_1000 	 all 0.3228 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.3284 
	ndcg 			 all 0.3368 
	ndcg_cut_10 	 all 0.4475 
	ndcg_cut_100 	 all 0.3540 
	ndcg_cut_1000 	 all 0.3376 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1847 
	P_1000 			 all 0.0185 
	recall_10 		 all 0.1093 
	recall_100 		 all 0.3394 
	recall_1000 	 all 0.3394 
	ndcg 			 all 0.3431 
	ndcg_cut_10 	 all 0.4583 
	ndcg_cut_100 	 all 0.3596 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3159 
	recall_1000 	 all 0.3159 
	ndcg 			 all 0.3182 
	ndcg_cut_10 	 all 0.4318 
	ndcg_cut_100 	 all 0.3345 
	ndcg_cut_1000 	 all 0.3190 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.3025 
	recall_1000 	 all 0.3025 
	ndcg 			 all 0.3014 
	ndcg_cut_10 	 all 0.3940 
	ndcg_cut_100 	 all 0.3167 
	ndcg_cut_1000 	 all 0.3023 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2245 
	bpref 			 all 0.2773 
	recip_rank 		 all 0.8832 
	P_10 			 all 0.7474 
	P_100 			 all 0.3597 
	P_1000 			 all 0.0360 
	recall_10 		 all 0.0819 
	recall_100 		 all 0.3392 
	recall_1000 	 all 0.3392 
	ndcg 			 all 0.3854 
	ndcg_cut_10 	 all 0.5755 
	ndcg_cut_100 	 all 0.4556 
	ndcg_cut_1000 	 all 0.3886 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2152 
	bpref 			 all 0.2629 
	recip_rank 		 all 0.8856 
	P_10 			 all 0.7053 
	P_100 			 all 0.3564 
	P_1000 			 all 0.0356 
	recall_10 		 all 0.0800 
	recall_100 		 all 0.3298 
	recall_1000 	 all 0.3298 
	ndcg 			 all 0.3818 
	ndcg_cut_10 	 all 0.5758 
	ndcg_cut_100 	 all 0.4520 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.5626 
	ndcg_cut_1000 	 all 0.4483 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.2646 
	P_1000 			 all 0.0265 
	recall_10 		 all 0.1615 
	recall_100 		 all 0.4867 
	recall_1000 	 all 0.4867 
	ndcg 			 all 0.4975 
	ndcg_cut_10 	 all 0.6336 
	ndcg_cut_100 	 all 0.5192 
	ndcg_cut_1000 	 all 0.4983 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.3453 
	bpref 			 all 0.3910 
	recip_rank 		 all 0.9770 
	P_10 			 all 0.8868 
	P_100 			 all 0.4563 
	P_1000 			 all 0.0456 
	recall_10 		 all 0.1218 
	recall_100 		 all 0.4423 
	recall_1000 	 all 0.4423 
	ndcg 			 all 0.5250 
	ndcg_cut_10 	 all 0.7611 
	ndcg_cut_100 	 all 0.6127 
	ndcg_cut_1000 	 all 0.5289 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.3387 
	bpref 			 all 0.3832 
	recip_rank 		 all 0.9836 
	P_10 			 all 0.8855 
	P_100 			 all 0.4497 
	P_1000 			 all 0.0450 
	recall_10 		 all 0.1197 
	recall_100 		 all 0.4359 
	recall_1000 	 all 0.4359 
	ndcg 			 all 0.5201 
	ndcg_cut_10 	 all 0.7601 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.5590 
	ndcg_cut_1000 	 all 0.4452 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2963 
	bpref 			 all 0.3429 
	recip_rank 		 all 0.8374 
	P_10 			 all 0.6697 
	P_100 			 all 0.2633 
	P_1000 			 all 0.0263 
	recall_10 		 all 0.1650 
	recall_100 		 all 0.4857 
	recall_1000 	 all 0.4857 
	ndcg 			 all 0.4966 
	ndcg_cut_10 	 all 0.6405 
	ndcg_cut_100 	 all 0.5181 
	ndcg_cut_1000 	 all 0.4974 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.4803 
	recall_1000 	 all 0.4803 
	ndcg 			 all 0.4935 
	ndcg_cut_10 	 all 0.6405 
	ndcg_cut_100 	 all 0.5152 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.3405 
	bpref 			 all 0.3842 
	recip_rank 		 all 0.9781 
	P_10 			 all 0.8908 
	P_100 			 all 0.4549 
	P_1000 			 all 0.0455 
	recall_10 		 all 0.1211 
	recall_100 		 all 0.4407 
	recall_1000 	 all 0.4407 
	ndcg 			 all 0.5230 
	ndcg_cut_10 	 all 0.7598 
	ndcg_cut_100 	 all 0.6111 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0784 
	P_1000 			 all 0.0078 
	recall_10 		 all 0.0289 
	recall_100 		 all 0.1382 
	recall_1000 	 all 0.1382 
	ndcg 			 all 0.1187 
	ndcg_cut_10 	 all 0.1345 
	ndcg_cut_100 	 all 0.1304 
	ndcg_cut_1000 	 all 0.1194 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2076 
	ndcg_cut_1000 	 all 0.1515 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0326 
	bpref 			 all 0.0693 
	recip_rank 		 all 0.2678 
	P_10 			 all 0.1474 
	P_100 			 all 0.0795 
	P_1000 			 all 0.0079 
	recall_10 		 all 0.0242 
	recall_100 		 all 0.1274 
	recall_1000 	 all 0.1274 
	ndcg 			 all 0.1138 
	ndcg_cut_10 	 all 0.1297 
	ndcg_cut_100 	 all 0.1249 
	ndcg_cut_1000 	 all 0.1146 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2159 
	ndcg_cut_1000 	 all 0.1571 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0832 
	P_1000 			 all 0.0083 
	recall_10 		 all 0.0250 
	recall_100 		 all 0.1396 
	recall_1000 	 all 0.1396 
	ndcg 			 all 0.1201 
	ndcg_cut_10 	 all 0.1297 
	ndcg_cut_100 	 all 0.1318 
	ndcg_cut_1000 	 all 0.1209 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.1972 
	ndcg_cut_1000 	 all 0.1482 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0346 
	bpref 			 all 0.0692 
	recip_rank 		 all 0.3091 
	P_10 			 all 0.1671 
	P_100 			 all 0.0717 
	P_1000 			 all 0.0072 
	recall_10 		 all 0.0337 
	recall_100 		 all 0.1426 
	recall_1000 	 all 0.1426 
	ndcg 			 all 0.1209 
	ndcg_cut_10 	 all 0.1459 
	ndcg_cut_100 	 all 0.1299 
	ndcg_cut_1000 	 all 0.1216 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.1797 
	ndcg_cut_1000 	 all 0.1369 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.0678 
	P_1000 			 all 0.0068 
	recall_10 		 all 0.0273 
	recall_100 		 all 0.1238 
	recall_1000 	 all 0.1238 
	ndcg 			 all 0.1057 
	ndcg_cut_10 	 all 0.1322 
	ndcg_cut_100 	 all 0.1146 
	ndcg_cut_1000 	 all 0.1065 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.1787 
	ndcg_cut_1000 	 all 0.1353 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0314 
	bpref 			 all 0.0611 
	recip_rank 		 all 0.2994 
	P_10 			 all 0.1461 
	P_100 			 all 0.0667 
	P_1000 			 all 0.0067 
	recall_10 		 all 0.0254 
	recall_100 		 all 0.1216 
	recall_1000 	 all 0.1216 
	ndcg 			 all 0.1046 
	ndcg_cut_10 	 all 0.1316 
	ndcg_cut_100 	 all 0.1136 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1642 
	P_1000 			 all 0.0164 
	recall_10 		 all 0.1082 
	recall_100 		 all 0.3292 
	recall_1000 	 all 0.3292 
	ndcg 			 all 0.3290 
	ndcg_cut_10 	 all 0.4247 
	ndcg_cut_100 	 all 0.3428 
	ndcg_cut_1000 	 all 0.3296 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.2259 
	recall_1000 	 all 0.2259 
	ndcg 			 all 0.2047 
	ndcg_cut_10 	 all 0.2322 
	ndcg_cut_100 	 all 0.2171 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3013 
	ndcg_cut_1000 	 all 0.2270 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.2454 
	recall_1000 	 all 0.2454 
	ndcg 			 all 0.2175 
	ndcg_cut_10 	 all 0.2462 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3023 
	ndcg_cut_1000 	 all 0.2279 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1301 
	P_1000 			 all 0.0130 
	recall_10 		 all 0.0598 
	recall_100 		 all 0.2434 
	recall_1000 	 all 0.2434 
	ndcg 			 all 0.2177 
	ndcg_cut_10 	 all 0.2440 
	ndcg_cut_100 	 all 0.2311 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2856 
	ndcg_cut_1000 	 all 0.2213 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1161 
	P_1000 			 all 0.0116 
	recall_10 		 all 0.0560 
	recall_100 		 all 0.2331 
	recall_1000 	 all 0.2331 
	ndcg 			 all 0.2044 
	ndcg_cut_10 	 all 0.2320 
	ndcg_cut_100 	 all 0.2157 
	ndcg_cut_1000 	 all 0.2052 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2867 
	ndcg_cut_1000 	 all 0.2206 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.2249 
	recall_1000 	 all 0.2249 
	ndcg 			 all 0.2053 
	ndcg_cut_10 	 all 0.2450 
	ndcg_cut_100 	 all 0.2171 
	ndcg_cut_1000 	 all 0.2061 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.2314 
	recall_1000 	 all 0.2314 
	ndcg 			 all 0.2119 
	ndcg_cut_10 	 all 0.2488 
	ndcg_cut_100 	 all 0.2234 
	ndcg_cut_1000 	 all 0.2127 
...
??? example "summary (trec_eval)"
	...
	P_1000 			 all 0.0162 
	recall_10 		 all 0.1093 
	recall_100 		 all 0.3102 
	recall_1000 	 all 0.3102 
	ndcg 			 all 0.3108 
	ndcg_cut_10 	 all 0.4238 
	ndcg_cut_100 	 all 0.3246 
	ndcg_cut_1000 	 all 0.3114 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.2939 
	ndcg_cut_1000 	 all 0.2210 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3150 
	ndcg_cut_1000 	 all 0.2379 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0974 
	bpref 			 all 0.1379 
	recip_rank 		 all 0.4659 
	P_10 			 all 0.3303 
	P_100 			 all 0.1374 
	P_1000 			 all 0.0137 
	recall_10 		 all 0.0581 
	recall_100 		 all 0.2440 
	recall_1000 	 all 0.2440 
	ndcg 			 all 0.2299 
	ndcg_cut_10 	 all 0.3041 
	ndcg_cut_100 	 all 0.2433 
	ndcg_cut_1000 	 all 0.2306 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.3467 
	ndcg_cut_1000 	 all 0.2654 
...
??? example "summary (trec_eval)"
	...
	P_100 			 all 0.1496 
	P_1000 			 all 0.0150 
	recall_10 		 all 0.0792 
	recall_100 		 all 0.2716 
	recall_1000 	 all 0.2716 
	ndcg 			 all 0.2626 
	ndcg_cut_10 	 all 0.3532 
	ndcg_cut_100 	 all 0.2775 
	ndcg_cut_1000 	 all 0.2634 
...
??? example "summary (trec_eval)"
	...
	recall_100 		 all 0.2860 
	recall_1000 	 all 0.2860 
	ndcg 			 all 0.2755 
	ndcg_cut_10 	 all 0.3733 
	ndcg_cut_100 	 all 0.2906 
	ndcg_cut_1000 	 all 0.2763 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.1662 
	bpref 			 all 0.2183 
	recip_rank 		 all 0.6948 
	P_10 			 all 0.4829 
	P_100 			 all 0.1801 
	P_1000 			 all 0.0180 
	recall_10 		 all 0.1186 
	recall_100 		 all 0.3411 
	recall_1000 	 all 0.3411 
	ndcg 			 all 0.3404 
	ndcg_cut_10 	 all 0.4544 
...
??? example "summary (ndcg)"
	...
	ndcg_cut_100 	 all 0.4573 
	ndcg_cut_1000 	 all 0.3595 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2122 
	bpref 			 all 0.2667 
	recip_rank 		 all 0.7522 
	P_10 			 all 0.5684 
	P_100 			 all 0.2053 
	P_1000 			 all 0.0205 
	recall_10 		 all 0.1375 
	recall_100 		 all 0.3755 
	recall_1000 	 all 0.3755 
	ndcg 			 all 0.3951 
	ndcg_cut_10 	 all 0.5402 
	ndcg_cut_100 	 all 0.4131 
	ndcg_cut_1000 	 all 0.3959 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2374 
	bpref 			 all 0.2873 
	recip_rank 		 all 0.8417 
	P_10 			 all 0.6434 
	P_100 			 all 0.2053 
	P_1000 			 all 0.0205 
	recall_10 		 all 0.1612 
	recall_100 		 all 0.3755 
	recall_1000 	 all 0.3755 
	ndcg 			 all 0.4163 
	ndcg_cut_10 	 all 0.6165 
	ndcg_cut_100 	 all 0.4350 
	ndcg_cut_1000 	 all 0.4171 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.2698 
	bpref 			 all 0.3246 
	recip_rank 		 all 0.8366 
	P_10 			 all 0.6658 
	P_100 			 all 0.2364 
	P_1000 			 all 0.0236 
	recall_10 		 all 0.1632 
	recall_100 		 all 0.4282 
	recall_1000 	 all 0.4282 
	ndcg 			 all 0.4597 
	ndcg_cut_10 	 all 0.6365 
	ndcg_cut_100 	 all 0.4794 
	ndcg_cut_1000 	 all 0.4604 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0816 
	bpref 			 all 0.1503 
	recip_rank 		 all 0.6371 
	P_10 			 all 0.3671 
	P_100 			 all 0.1880 
	P_1000 			 all 0.0188 
	recall_10 		 all 0.0375 
	recall_100 		 all 0.1756 
	recall_1000 	 all 0.1756 
	ndcg 			 all 0.1934 
	ndcg_cut_10 	 all 0.2721 
	ndcg_cut_100 	 all 0.2270 
	ndcg_cut_1000 	 all 0.1951 
...
??? example "summary (trec_eval)"
	...
	recall_1000 	 all 0.1756 
	ndcg 			 all 0.2059 
	ndcg_cut_10 	 all 0.3387 
	ndcg_cut_100 	 all 0.2430 
	ndcg_cut_1000 	 all 0.2079 
...
??? example "summary (trec_eval)"
	...
	map 			 all 0.0909 
	bpref 			 all 0.1505 
	recip_rank 		 all 0.6665 
	P_10 			 all 0.4184 
	P_100 			 all 0.1880 
	P_1000 			 all 0.0188 
	recall_10 		 all 0.0485 
	recall_100 		 all 0.1756 
	recall_1000 	 all 0.1756 
	ndcg 			 all 0.2038 
	ndcg_cut_10 	 all 0.3227 
	ndcg_cut_100 	 all 0.2392 
	ndcg_cut_1000 	 all 0.2056 
